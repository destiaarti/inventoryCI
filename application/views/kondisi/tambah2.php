  <div class="content-wrapper">
    ...
    <?php
$count_barang = $this->db->query("SELECT * FROM kondisi2 ORDER BY id_kondisi2 DESC LIMIT 1");
 foreach($count_barang->result() as $i){
  $datakode = $i->id_kondisi2;
 }
if (!empty($datakode)) {
...
//form open
echo form_open(base_url('kondisi/tambah2'));
?>
...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" name="id_kondisi2" value="<?php echo $hasilkode ?>" id="id_kondisi2" class="form-control" placeholder="ID Kondisi" readonly>
	</div>
	<!-- <div class="form-group">
		<label>Tahun</label>
