          ...
          <table class="table table-bordered table-striped scroll" style="background-color:white;">
            <tr><th> Validasi</th><td>
                ...
                <tr> <th>Kondisi Barang</th>
                      <td><font size="4px"><div class="label label-default"><?php echo $barangmasuk->kondisi?></div></font></td>
                </tr>
                <tr> <th>Tahun Produksi</th>
                      <td><font size="4px"><div class="label label-default"><?php echo $barangmasuk->tahun?></div></font></td>
                </tr>
                <tr> <th>Status</th>
                      <td><font size="4px"><div class="label label-default"><?php echo $barangmasuk->status?></div></font></td>
                </tr>
                <tr> <th>Pengadaan</th>
                      <td><font size="4px"><div class="label label-default"><?php echo $barangmasuk->pengadaan?></div></font></td>
                </tr>
                <tr> <th>Jumlah</th>
                      <td><font size="4px"><div class="label label-default"><?php echo $barangmasuk->jumlah?></div></font></td>
                </tr>
                <tr> <th>Harga Per Satuan</th>
                      <td><font size="4px"><div class="label label-default"><?php echo $barangmasuk->harga?></div></font></td>
                </tr>
         </div>
