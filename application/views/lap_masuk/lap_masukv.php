...
<div class="row">
    <div id="lap_hari" class="col-md-4"><?php $this->load->view('lap_masuk/lap_masukhari') ?></div>
    <div id="lap_bulan" class="col-md-4"><?php $this->load->view('lap_masuk/lap_masukbln') ?></div>
    <div id="lap_thn" class="col-md-4"><?php $this->load->view('lap_masuk/lap_masukthn') ?></div>
</div>
